[CmdletBinding()]
param(
  [ValidateSet('estado', 'personalidade', 'atualizar', 'contexto', 'experiencia', 'candidatas', 'arquivo', 'manutencao', 'lembrar', 'licao', 'confirmar', 'descartar', 'atualizar-memoria', 'obsoleta', 'consolidar', 'atalhos', 'atalho-observar', 'atalho-validar', 'melhorias', 'melhoria-propor', 'melhoria-avaliar', 'melhoria-aprovar', 'melhoria-rejeitar', 'melhoria-promover', 'melhoria-operacional-promover', 'falhas', 'falha-registrar', 'falha-analisar', 'falha-testar', 'falha-avaliar', 'falha-automacao-reivindicar', 'falha-automacao-concluir', 'falha-automacao-bloquear', 'eval-suite', 'eval-historico', 'eval-registrar', 'eval-comparar', 'checkpoints', 'checkpoint-registrar', 'backlog', 'descoberta-registrar', 'ciclo', 'delegacoes', 'delegacao-preparar', 'delegacao-estado', 'varredura-dia', 'varreduras', 'repo-configurar', 'repo-status')]
  [string]$Acao = 'estado',
