...
export const privateAccessCapabilities = {
  privateAttachment: { storage: 'windows-encrypted-context', retentionBeforeRegistrationDays: 30, survivesRestart: true, binding: 'conversation-and-message', rawInChat: false, rawInModel: false, automaticValidation: false },
  vault: { registration: true, metadataLookup: true, verificationOnRequest: true, registrationRequiresConnectionTest: false, registeredAccessRecall: true },
